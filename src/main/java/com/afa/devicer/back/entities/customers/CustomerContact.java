...
@AllArgsConstructor
@Entity
@Table(name = "bp_customer_contacts",
        indexes = {
                @Index(name = "idx_bp_customer_contacts_customer_id", columnList = "customer_id"),
                @Index(name = "idx_bp_customer_contacts_person_id", columnList = "person_id")
        })
