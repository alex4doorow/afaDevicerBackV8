...
public class MoscowCourierTypicalDeliveryCalculator extends BaseDeliveryCalculator<Void> implements DeliveryCalculator {

    public MoscowCourierTypicalDeliveryCalculator(
            final Order order,
