...
public class MoscowCourierFastDeliveryCalculator extends BaseDeliveryCalculator<Void> implements DeliveryCalculator {

    public MoscowCourierFastDeliveryCalculator(
            final Order order,
    ...
    public DeliveryCalcParcelDto calc() {
        final BigDecimal deliveryPrice = DeliveryPriceTypes.COURIER_MOSCOW_FAST.getPrice();
